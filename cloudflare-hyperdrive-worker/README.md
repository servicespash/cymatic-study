...
_(Copy the generated Hyperdrive ID and place it in your `wrangler.jsonc`)_
...
- **Headers**:
  ...
  - `x-api-key: [YOUR_PROXY_API_KEY]` _(Only if PROXY_API_KEY secret is configured on Cloudflare)_
- **Body**:
